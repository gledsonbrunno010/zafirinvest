...
const Particles = ({
    ...
    useEffect(() => {
        ...
        const update = (t: number) => {
            // If not visible, just keep requesting frame to check later or pause fully?
            // Better to pause fully via IntersectionObserver, but if we animate time we need consistent elapsed.
            // We will only render if isVisibleRef.current is true.
            ...
            if (isVisibleRef.current) {
                ...
                // Update time even if not rendering to avoid jumps, or just timestamp
                lastTime = t;
            }
        ...
        // Use IntersectionObserver to toggle rendering
